...
namespace RenderHeads.Media.AVProVideo
{
	...
	{
		public const string AVProVideoVersion = "2.5.1";
		public sealed class ExpectedPluginVersion
		{
			public const string Windows      = "2.5.1";
			public const string WinRT        = "2.5.1";
			public const string Android      = "2.5.1";
			public const string Apple        = "2.5.1";
		}
